window.__ModuleLoader__.load({
	id: "@chatecnu-work/dsh-client-ui-agent-preset-product",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>\\packages\client\ui-agent-preset\src\client\AgentPresetLabel.module.css.mjs
		const css$2 = ".ssCnzG_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.ssCnzG_icon{opacity:.7;flex:none}";
		const tagId$2 = "@chatecnu-work/dsh-client-ui-agent-preset-product/AgentPresetLabel.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@chatecnu-work/dsh-client-ui-agent-preset-product";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>\\packages\client\ui-agent-preset\src\client\AgentPresetSeat.module.css.mjs
		const css$1 = ".np99-q_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.np99-q_seat:not(:disabled):hover,.np99-q_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.np99-q_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.np99-q_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.np99-q_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both np99-q_seat-icon-in}@keyframes np99-q_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.np99-q_introText{white-space:pre;display:inline-block}.np99-q_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards np99-q_seat-char-in;display:inline-block}@keyframes np99-q_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.np99-q_introIcon,.np99-q_introChar{opacity:1;animation:none}}.np99-q_chevron{color:var(--dsw-alias-label-caption);flex:none}.np99-q_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.np99-q_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.np99-q_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		const tagId$1 = "@chatecnu-work/dsh-client-ui-agent-preset-product/AgentPresetSeat.module.css";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "np99-q_chevron",
			"introChar": "np99-q_introChar",
			"introIcon": "np99-q_introIcon",
			"introText": "np99-q_introText",
			"item": "np99-q_item",
			"itemDesc": "np99-q_itemDesc",
			"itemName": "np99-q_itemName",
			"seat": "np99-q_seat",
			"seat-char-in": "np99-q_seat-char-in",
			"seat-icon-in": "np99-q_seat-icon-in",
			"seatIcon": "np99-q_seatIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>\\packages\client\ui-agent-preset\src\client\AgentPresetSection.module.css.mjs
		const css = ".QTYCXa_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.QTYCXa_title{margin:0;font-size:18px;font-weight:600}.QTYCXa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.QTYCXa_group{flex-direction:column;gap:10px;display:flex}.QTYCXa_group+.QTYCXa_group{margin-top:20px}.QTYCXa_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.QTYCXa_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.QTYCXa_card{border:.5px solid var(--dsw-alias-border-l4);background:0 0;border-radius:20px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.QTYCXa_card:hover:not(.QTYCXa_cardActive){background:var(--dsw-alias-interactive-bg-hover)}.QTYCXa_cardActive{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}.QTYCXa_cardBroken,.QTYCXa_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.QTYCXa_brokenBadge{corner-shape:round;white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.QTYCXa_brokenTip{z-index:1;background:var(--dsw-alias-label-primary);width:max-content;max-width:100%;color:var(--dsw-alias-bg-layer-3);text-align:left;white-space:pre-line;overflow-wrap:anywhere;opacity:0;pointer-events:none;border-radius:6px;padding:6px 8px;font-size:11px;font-weight:400;line-height:1.5;transition:opacity .12s;position:absolute;top:calc(100% + 6px);left:0}.QTYCXa_brokenBadge:hover .QTYCXa_brokenTip,.QTYCXa_cardMain:focus-visible .QTYCXa_brokenTip{opacity:1}.QTYCXa_cardMain[aria-disabled=true]{cursor:default}.QTYCXa_cardBrokenReason{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.QTYCXa_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.QTYCXa_cardMain:disabled{cursor:default}.QTYCXa_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.QTYCXa_cardHead{align-items:center;gap:8px;display:flex;position:relative}.QTYCXa_cardName{font-size:15px;font-weight:600;line-height:1.4}.QTYCXa_badge,.QTYCXa_inUse{corner-shape:round;white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.QTYCXa_badge{border:.5px solid var(--dsw-alias-border-l4);color:var(--dsw-alias-label-tertiary)}.QTYCXa_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.QTYCXa_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.QTYCXa_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-tertiary);margin-top:auto;font-size:11px}.QTYCXa_cardFoot{border-top:.5px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.QTYCXa_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.QTYCXa_iconButton:disabled{opacity:.4;cursor:default}.QTYCXa_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.QTYCXa_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.QTYCXa_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.QTYCXa_iconButton:hover:after,.QTYCXa_iconButton:focus-visible:after{opacity:1}.QTYCXa_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.QTYCXa_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.QTYCXa_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.QTYCXa_revealedPathLabel{white-space:nowrap}.QTYCXa_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.QTYCXa_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.QTYCXa_secondaryButton:disabled{opacity:.5;cursor:default}.QTYCXa_field{flex-direction:column;gap:6px;display:flex}.QTYCXa_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.QTYCXa_input{box-sizing:border-box;border:.5px solid var(--dsw-alias-border-l4);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.QTYCXa_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.QTYCXa_input::placeholder{color:var(--dsw-alias-label-dimmed)}.QTYCXa_dialog{width:min(560px,100%)}.QTYCXa_dialogFields{flex-direction:column;gap:12px;display:flex}.QTYCXa_viewerCode{border:.5px solid var(--dsw-alias-border-l4);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.QTYCXa_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.QTYCXa_deleteDialog{width:min(480px,100%)}.QTYCXa_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.QTYCXa_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.QTYCXa_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:20px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.QTYCXa_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.QTYCXa_creatorButton:disabled{opacity:.4;cursor:default}";
		const tagId = "@chatecnu-work/dsh-client-ui-agent-preset-product/AgentPresetSection.module.css";
		...
		var AgentPresetSection_module_css_default = {
			"badge": "QTYCXa_badge",
			"brokenBadge": "QTYCXa_brokenBadge",
			"brokenTip": "QTYCXa_brokenTip",
			"card": "QTYCXa_card",
			"cardActive": "QTYCXa_cardActive",
			"cardBroken": "QTYCXa_cardBroken",
			"cardBrokenReason": "QTYCXa_cardBrokenReason",
			"cardDesc": "QTYCXa_cardDesc",
			"cardFoot": "QTYCXa_cardFoot",
			"cardHead": "QTYCXa_cardHead",
			"cardId": "QTYCXa_cardId",
			"cardMain": "QTYCXa_cardMain",
			"cardName": "QTYCXa_cardName",
			"cards": "QTYCXa_cards",
			"creatorButton": "QTYCXa_creatorButton",
			"deleteConfirm": "QTYCXa_deleteConfirm",
			"deleteDialog": "QTYCXa_deleteDialog",
			"dialog": "QTYCXa_dialog",
			"dialogFields": "QTYCXa_dialogFields",
			"error": "QTYCXa_error",
			"field": "QTYCXa_field",
			"fieldLabel": "QTYCXa_fieldLabel",
			"group": "QTYCXa_group",
			"groupHead": "QTYCXa_groupHead",
			"iconButton": "QTYCXa_iconButton",
			"iconDanger": "QTYCXa_iconDanger",
			"inUse": "QTYCXa_inUse",
			"input": "QTYCXa_input",
			"intro": "QTYCXa_intro",
			"revealedPath": "QTYCXa_revealedPath",
			"revealedPathLabel": "QTYCXa_revealedPathLabel",
			"secondaryButton": "QTYCXa_secondaryButton",
			"section": "QTYCXa_section",
			"title": "QTYCXa_title",
			"viewerCode": "QTYCXa_viewerCode"
		};
		//#endregion
