...
const stringParameter = name => Object.freeze({ name, wire: name, source: 'json', codec: Object.freeze({ mode: 'strict', create() { return this.schema }, typeSymbol: `@chatecnu-work/dsh-artifact-preview-native#${name}`, schema: z.string() }) })
...
export const result = Object.freeze({
  mode: 'strict', create() { return this.schema }, typeSymbol: '@chatecnu-work/dsh-artifact-preview-native#ArtifactPreview',
...
export const revealResult = Object.freeze({
  mode: 'strict', create() { return this.schema }, typeSymbol: '@chatecnu-work/dsh-artifact-preview-native#ArtifactReveal',
...
export const importParameters = [
  ...
  Object.freeze({
    ...
    codec: Object.freeze({
      mode: 'strict', create() { return this.schema }, typeSymbol: '@chatecnu-work/dsh-artifact-preview-native#WorkspaceImportFiles',
...
export const importResult = Object.freeze({
  mode: 'strict', create() { return this.schema }, typeSymbol: '@chatecnu-work/dsh-artifact-preview-native#WorkspaceImportResult',
  schema: z.object({
