window.__ModuleLoader__.load({
	id: "@chatecnu-work/dsh-client-ui-conversation-brand",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/input/editor/ReferenceChip.module.css.mjs
		...
		const tagId$9 = "@chatecnu-work/dsh-client-ui-conversation-brand/ReferenceChip.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$9) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@chatecnu-work/dsh-client-ui-conversation-brand";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/input/editor/composer-editor.module.css.mjs
		...
		const tagId$8 = "@chatecnu-work/dsh-client-ui-conversation-brand/composer-editor.module.css";
 ...
 /* v8 ignore next 4 -- plain-text composition nests no block elements today; the walk stays total for imported states. */
		...
		*/
		...
		const en = {
			...
			"hero.headline": "What shall we accomplish today?",
			"hero.preview": "DEV",
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/queue/QueueDock.module.css.mjs
		...
		const tagId$7 = "@chatecnu-work/dsh-client-ui-conversation-brand/QueueDock.module.css";
		...
		*/
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [rowCount > 1 && (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [listVisible && queue.map((row) => {
							...
							return (0, react_jsx_runtime.jsxs)("li", {
								...
								children: [
									...
									}) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [imageRefs.length > 0 && (0, react_jsx_runtime.jsx)("span", {
										className: QueueDock_module_css_default.thumbs,
										children: imageRefs.map((attachment, index) => (0, react_jsx_runtime.jsx)(QueueThumb, {
											attachment,
											loadImage,
											label: t("queue.image")
						...
						}), listVisible && pendingQueue.map((submission) => (0, react_jsx_runtime.jsxs)("li", {
							className: QueueDock_module_css_default.row,
							...
							children: [
								...
								submission.images.length > 0 && (0, react_jsx_runtime.jsx)("span", {
									className: QueueDock_module_css_default.thumbs,
									children: submission.images.map((image, index) => (0, react_jsx_runtime.jsx)("img", {
										className: QueueDock_module_css_default.thumb,
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/settings/EnterBehaviorRow.module.css.mjs
		...
		const tagId$6 = "@chatecnu-work/dsh-client-ui-conversation-brand/EnterBehaviorRow.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/skeleton/HeroShell.module.css.mjs
		...
		const tagId$5 = "@chatecnu-work/dsh-client-ui-conversation-brand/HeroShell.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/skeleton/ConversationRoot.module.css.mjs
		...
		const tagId$4 = "@chatecnu-work/dsh-client-ui-conversation-brand/ConversationRoot.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/skeleton/ContextMeter.module.css.mjs
		...
		const tagId$3 = "@chatecnu-work/dsh-client-ui-conversation-brand/ContextMeter.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/skeleton/PermissionSelect.module.css.mjs
		...
		const tagId$2 = "@chatecnu-work/dsh-client-ui-conversation-brand/PermissionSelect.module.css";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/skeleton/InputBar.module.css.mjs
		...
		const tagId$1 = "@chatecnu-work/dsh-client-ui-conversation-brand/InputBar.module.css";
		...
		*/
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										insertReference: (reference) => {
											...
											if (snapshot === undefined || typeof keyboard?.insertReference !== "function") return false;
											const span = keyboard.caretSpan();
											return keyboard.insertReference(reference, { ...span, draftRev: snapshot.draftRev });
										},
										openCommands: onToggleCommandMenu,
										commandMenuOpen,
										notify: showToast
									}) ?? (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
		...
		//#endregion
		//#region \0dsh-css:<dsh-upstream>/packages/client/ui-conversation/src/client/skeleton/TodoPanel.module.css.mjs
		...
		const tagId = "@chatecnu-work/dsh-client-ui-conversation-brand/TodoPanel.module.css";
